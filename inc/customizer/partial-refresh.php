...
function best_shop_get_footer_copyright(){
    ...
    echo '<span class="copy-right">';
        ...
        if(function_exists('best_shop_pro_textdomain')) {
            ...
            if($copyright === ''){
            //free text domain
                echo ' <a href="https://gradientthemes.com">' . esc_html('A theme by Gradient Themes ©' , 'best-shop') . '</a> ';
            } else{
                echo ' <a href="https://gradientthemes.com">' . esc_html(best_shop_get_setting( 'footer_copyright' )) . '</a> ';
            }
        }
